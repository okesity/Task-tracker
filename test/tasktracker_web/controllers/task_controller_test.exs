defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{desc: "some desc", name: "some name", work_time: 42}
  @update_attrs %{desc: "some updated desc", name: "some updated name", work_time: 43}
  @invalid_attrs %{desc: nil, name: nil, work_time: nil}
